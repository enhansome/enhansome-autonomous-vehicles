...
A curated list of awesome autonomous vehicles resources, inspired by [awesome-php](https://github.com/ziadoz/awesome-php) ⭐ 32,656 | 🐛 83 | 📅 2026-07-13.
...
1. [Awesome Machine Learning](https://github.com/josephmisiti/awesome-machine-learning) ⭐ 74,067 | 🐛 26 | 🌐 Python | 📅 2026-08-11 - A curated list of awesome Machine Learning frameworks, libraries and software. Maintained by Joseph Misiti.Joseph Misiti
...
1. [Awesome Robotics](https://github.com/Kiloreux/awesome-robotics) ⭐ 6,960 | 🐛 37 | 📅 2024-09-22 - A list of various books, courses and other resources for robotics, maintained by kiloreux.

### Computer Vision

1. [Awesome Computer Vision](https://github.com/jbhuang0604/awesome-computer-vision) ⭐ 23,504 | 🐛 91 | 📅 2024-05-17 - A curated list of awesome computer vision resources, maintained by Jia-Bin Huang
...
1. [Autoware](https://github.com/CPFL/Autoware) ⭐ 11,994 | 🐛 74 | 🌐 Dockerfile | 📅 2026-08-18 - Integrated open-source software for urban autonomous driving.

* [Comma.ai Openpilot](https://github.com/commaai/openpilot) ⭐ 63,447 | 🐛 121 | 🌐 Python | 📅 2026-08-19 - an open source driving agent.
...
1. [NeuroJS](https://github.com/janhuenermann/neurojs) ⭐ 4,372 | 🐛 6 | 🌐 JavaScript | 📅 2023-10-10 - A javascript deep learning and reinforcement learning library. A sample self-driving car implementation.
2. [DonkeyCar](https://github.com/autorope/donkeycar) ⭐ 3,492 | 🐛 134 | 🌐 Python | 📅 2026-08-17 - A minimalist and modular self driving library for Python. It is developed for hobbyists and students with a focus on allowing fast experimentation and easy community contributions.
