...
A curated list of awesome autonomous vehicles resources, inspired by [awesome-php](https://github.com/ziadoz/awesome-php) ⭐ 32,700 | 🐛 92 | 📅 2026-07-13.
...
1. [Awesome Machine Learning](https://github.com/josephmisiti/awesome-machine-learning) ⭐ 74,361 | 🐛 29 | 🌐 Python | 📅 2026-09-17 - A curated list of awesome Machine Learning frameworks, libraries and software. Maintained by Joseph Misiti.Joseph Misiti

* [Deep Learning Papers Reading Roadmap](https://github.com/songrotek/Deep-Learning-Papers-Reading-Roadmap) ⭐ 39,558 | 🐛 91 | 🌐 Python | 📅 2022-11-27 - Deep Learning papers reading roadmap constructed from outline to detail, old to state-of-the-art,
...
1. [Awesome Robotics](https://github.com/Kiloreux/awesome-robotics) ⭐ 7,169 | 🐛 40 | 📅 2024-09-22 - A list of various books, courses and other resources for robotics, maintained by kiloreux.

### Computer Vision

1. [Awesome Computer Vision](https://github.com/jbhuang0604/awesome-computer-vision) ⭐ 23,558 | 🐛 97 | 📅 2024-05-17 - A curated list of awesome computer vision resources, maintained by Jia-Bin Huang
...
1. [Autoware](https://github.com/CPFL/Autoware) ⭐ 12,067 | 🐛 70 | 🌐 Dockerfile | 📅 2026-09-18 - Integrated open-source software for urban autonomous driving.

* [Comma.ai Openpilot](https://github.com/commaai/openpilot) ⭐ 63,676 | 🐛 150 | 🌐 Python | 📅 2026-09-18 - an open source driving agent.
...
2. [DonkeyCar](https://github.com/autorope/donkeycar) ⭐ 3,506 | 🐛 137 | 🌐 Python | 📅 2026-09-14 - A minimalist and modular self driving library for Python. It is developed for hobbyists and students with a focus on allowing fast experimentation and easy community contributions.
